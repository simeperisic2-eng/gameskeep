 ...
 * catalog's existing genre data. Each chip will deep-link into a filtered catalog
 * in I5b; for now it points at the games section, degrading gracefully.
 */
  ...
  return (
    <section className="gk-container gk-section-tight" aria-label="Browse by genre">
      ...
      <div className="gk-genre-rail">
        {genres.map((g) => (
          <a key={g.name} className="gk-genre-chip" href="/games">
